    ...
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Rooms & Accomodation</a></li> 
...
<!--         <div class="search_button">
        ...
        <!-- Header Link -->
        <div class="header_link"><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Book Your Room Now</a></div>
  ...
  <div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images/homed.jpg" data-speed="0.8"></div>
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Marimar</h1></div>
      <div class="home_text text-center">We always endeavor to treat you with utmost respect</div>
      <div class="button home_button"><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">book now</a></div>
    </div>
  </div>
          ...
          <div class="booking_container d-flex flex-row align-items-end justify-content-start"> 
            <form action="<?php echo WEB_ROOT;?>index.php?p=booking" method="POST" class="booking_form" autocomplete="off">
              <div class="booking_form_container d-flex flex-lg-row flex-column align-items-start justify-content-start flex-wrap">
                ...
                <button class="booking_form_button ml-lg-auto">Check Room Availability</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-end align-items-center justify-content-start">
                  ...
                  <div style="color:#0c881d;"><strong>MARIMAR HOTEL & RESTAURANT</strong></div>
                  <div><p style="color:#ffff;">"Our Mission is to create outstanding facilities faithfully reflecting ethnic designs that offer the highest standards of product and service and to provide Management and staff with an environment that enables them to deliver operating standards beyond the level of our guests’ expectations, resulting in satisfactory returns to our stakeholders."</p>
            </div>  
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                  <div style="color:#0c881d;"><strong>QUICK LINKS</strong></div>
                  <div><a href="<?php echo WEB_ROOT;?>index.php">Home</a></div>
                  <div><a href="<?php echo WEB_ROOT;?>index.php?p=about">About us</a></div>
                  <div><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Rooms & Acommodation</a></div>
                  <div><a href="<?php echo WEB_ROOT;?>index.php?p=contact">Contact</a></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                  <div style="color:#0c881d;"><strong>ADDRESS</strong></div>
                    <div>George Williamson House,</div>
                    <div> 4th Floor, 4th Ngong Avenue</div>
                    <div> Nairobi, Kenya</div>
                    <div style="color:#0c881d;"><strong>MAIL</strong></div>
                    <div>info@marimar.com</div>
                    <div style="color:#0c881d;"><strong>PHONE</strong></div>
                    <div>+254-712-061-517</div>
                  </div>
                </div>
              </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |----Marimar Hotel & Restaurant------<a href="#" target="_blank">Sostine Waliaula</a>
